...
Feature: I want to add user in domain who expected to be follow another user and verify he/she see the shout in his/her feed
    ...
    And fill create user details with "test" , "fan24@rediffmail.com" and "Password" 
    And submit Signup form 
    Then logout

  Scenario: verify user able to follow a user and see the shout in his/her feed 
    Given I navigate to bandlab homepage
    When I login with my credentials i.e. "fan24@rediffmail.com" and "Password"
    And follow user "kkbit234master23"
    Then navigate to feed page and verify the "kkbit234master23" users' shout is available in my feed
    And logout